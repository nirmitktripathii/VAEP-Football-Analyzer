...
def plot_tactical_summary_pitch(summary_df):
    """
    Creates a realistic pitch comparison with Convex Hull team shapes.
    """
    ...
    for i, ax in enumerate(axes):
        ...
        if len(points) >= 3:
            ...
            ax.plot(np.append(hull_points[:, 0], hull_points[0, 0]), 
                    ...
                    color='#00CCFF', alpha=0.5, linewidth=2, zorder=2)
        
        # Plot Players (Median Positions)
        for p in positions:
